package com.mobileapplication.todoapp.data;
...
import com.mobileapplication.todoapp.model.Priority;
import com.mobileapplication.todoapp.model.Task;
import com.mobileapplication.todoapp.util.Converter;
...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, Task value) {
        ...
        final String _tmp;
        _tmp = Converter.fromPriority(value.priority);
        if (_tmp == null) {
          stmt.bindNull(3);
        } else {
        ...
        final Long _tmp_1;
        _tmp_1 = Converter.dateToTimeStamp(value.dueDate);
        if (_tmp_1 == null) {
          stmt.bindNull(4);
        } else {
        ...
        final Long _tmp_2;
        _tmp_2 = Converter.dateToTimeStamp(value.dateCreated);
        if (_tmp_2 == null) {
          stmt.bindNull(5);
        } else {
  ...
  public LiveData<Task> get(final long id) {
    final String _sql = "SELECT * FROM task_table WHERE task_id == ?";
